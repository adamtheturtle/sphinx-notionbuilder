...
If your project has multiple documents connected via ``toctree``, all documents are published under the configured parent.
The root document is published with the configured ``notion_page_title``, and other documents use their document titles.
