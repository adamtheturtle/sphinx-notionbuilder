...
from ultimate_notion.blocks import AnyBlock
...
def _assert_rst_converts_to_notion_objects(
    *,
    rst_content: str,
    expected_objects: list[AnyBlock],
    ...
    for notion_object in expected_objects:
        # Pyright ignore not needed in Ultimate-Notion 0.9+.
        obj_ref = notion_object.obj_ref  # pyright: ignore[reportUnknownMemberType, reportUnknownVariableType]
...
def test_inline_formatting(
    *,
    ...
    expected_objects: list[AnyBlock] = [expected_paragraph]
...
def test_admonition_with_code_block_first(
    *,
    ...
    expected_objects: list[AnyBlock] = [callout]
    _assert_rst_converts_to_notion_objects(
        rst_content=rst_content,
        expected_objects=expected_objects,
        make_app=make_app,
...
def test_simple_table(
    *,
    ...
    expected_objects: list[AnyBlock] = [table]
